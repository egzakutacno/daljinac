Write-Host "Daljinac Installer (STABLE v2.3.7)" -ForegroundColor Cyan

$Dir = "C:\daljinac"
$Exe = "$Dir\daljinac.exe"
$URL = "https://github.com/egzakutacno/daljinac/releases/download/v2.3.7/daljinac.exe"

Write-Host "[1/3] Downloading daljinac.exe (STABLE v2.3.7)..."
...
Write-Host "  STABLE v2.3.7 installed"
